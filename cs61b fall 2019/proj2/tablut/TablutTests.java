...
public class TablutTests {
    ...
    /**
     * Tests legalMoves for white pieces to ma
    ...
    public void testLegalWhiteMoves() {
        ...
        List<Move> movesList = cs.legalMoves(Piece.WHITE);
    ...
    public void testLegalBlackMoves() {
        Board cs2 = new Board();
        List<Move> movesList = cs2.legalMoves(Piece.BLACK);
