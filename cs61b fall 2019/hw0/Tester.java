...
public class Tester {
    ...
    @Test
    public void maxTest_for() {
        // Change call to max to make this call yours.
        assertEquals(14, Max_for.main(new int[] { 0, -5, 2, 14, 10 }));
        // REPLACE THIS WITH MORE TESTS.
    }

      @Test
    public void maxTest_while() {
        // Change call to max to make this call yours.
        assertEquals(14, Max_while.main(new int[] { 0, -5, 2, 14, 10 }));
        // REPLACE THIS WITH MORE TESTS.
    }
    ...
    public void threeSumTest() {
        ...
        assertTrue(SUM_3.main(new int[] { -6, 3, 10, 200 }));
        // REPLACE THIS WITH MORE TESTS.
    }
    ...
    public void threeSumDistinctTest() {
        ...
        assertFalse(SUM_distinct.main(new int[] { -6, 3, 10, 200 }));
        // REPLACE THIS WITH MORE TESTS.
    }
